...
The barplot created by `compare_auc_values` is different: it summarizes and compares the final AUC values of several numerical attributes in one figure. The association matrix plot gives a compact visual summary of pairwise relationships between the selected variables.
